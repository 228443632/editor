        ...
        data: [
          {
            ...
            commissionPlanList: [
              ...
              { clctRate: '达成率＜50.00%', clctCommissionRate: '0.5' },
              { clctRate: '50.00%≤达成率＜80%', clctCommissionRate: '0.8' },
              { clctRate: '80.00%≤达成率', clctCommissionRate: '1' },
              {
                clctRate: '留案案件回款率',
                clctCommissionRate: '佣金费率',
                headerFlag: 'Y',
              },
              { clctRate: '回款率＜10.00%', clctCommissionRate: '4%' },
              { clctRate: '10.00%≤回款率＜30.00%', clctCommissionRate: '5%' },
              { clctRate: '30.00%≤回款率', clctCommissionRate: '6%' },
            ],
          },
          {
            assetType: '消费金融',
            commissionPlanList: [
              ...
              { clctRate: '回款率＜30.00%', clctCommissionRate: '2%' },
              { clctRate: '30.00%≤回款率＜60.00%', clctCommissionRate: '2.1%' },
              { clctRate: '60.00%≤回款率＜80.00%', clctCommissionRate: '2.4%' },
              { clctRate: '80.00%≤回款率', clctCommissionRate: '3%' },
              {
                clctRate: '留案案件回款率',
                clctCommissionRate: '佣金费率',
                headerFlag: 'Y',
              },
              { clctRate: '回款率＜30.00%', clctCommissionRate: '3%' },
              { clctRate: '30.00%≤回款率＜60.00%', clctCommissionRate: '3.5%' },
              { clctRate: '60.00%≤回款率', clctCommissionRate: '4%' },
            ],
          },
        ],
      }
